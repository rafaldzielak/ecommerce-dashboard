  ...
  return (
    <>
      ...
      <div className='flex items-center justify-between'>
        ...
        {!!initialData && (
          <Button disabled={isLoading} variant='destructive' color='sm' onClick={() => setIsOpen(true)}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input disabled={isLoading} {...field} placeholder='Color name' />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className='flex items-center gap-x-4'>
                      <Input disabled={isLoading} {...field} placeholder='Color value' />
